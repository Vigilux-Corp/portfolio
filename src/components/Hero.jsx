...
function Hero() {
  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-10 md:items-center">
      <div className="px-8">
        <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-primary">Start your journey with <span className="text-blue-600">Vigilux</span></h1>
        <p className="mt-3 text-lg text-gray-800 dark:text-gray-900">Hand-picked professionals and expertly crafted softwares, designed for any kind of entrepreneur.</p>
      ...
      <div className="relative ms-4">
        <img className="w-full rounded-md" src="https://images.unsplash.com/photo-1665686377065-08ba896d16fd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=700&h=800&q=80" alt="Image Description"></img>
